...
{
    public class LDLSandCBASE : LDLBOBase,  ILDLHasGraphicLocation
    {
        ...
        protected override IEnumerable<BOTripple> GetCustomTripples()
        {
            ...
            if (NormalPath != null)
            {
                ...
                BOTripple startNodeTripple = new BOTripple(this.AsNode, new BONode(LDLUris.StartNodeProperty), startNodeObject);
                results.Add(startNodeTripple);
            }
        
            BONode normalEndNode = this.NormalPath.Track2.AsNode;
            BOTripple normalEndNodeTripple = new BOTripple(this.AsNode, new BONode(LDLUris.EndNodeProperty), normalEndNode);
            results.Add(normalEndNodeTripple);
            BONode alternativeEndNode = this.ReversePath.Track2.AsNode;
            BOTripple altEndNodeTripple = new BOTripple(this.AsNode, new BONode(LDLUris.EndNodeProperty), alternativeEndNode);
